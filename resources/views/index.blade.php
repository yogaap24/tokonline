...
<head>
  ...
  <link rel="icon" href="http://kursus-online.lazday.com/silabus/img/lazday-icon.ico">
  <title>Online Shop - Yogaap24</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href=" {{ route('home') }} " class="logo">
        ...
        <span class="logo-lg"><b>Online</b>Shop</span>
      </a>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href=" {{ route('products.index') }} "><i class="fa fa-dropbox"></i> Product </a></li>
            </ul>
          </li>
